...
%
% Input:
%   STEP01B_Resting_QC_Final folder selected by the user.
%
% Output:
%   STEP01D_Resting_Final folder created beside the selected input folder.
%
% This script:
...
%% Paths
% Select the local STEP01B output folder. This avoids machine-specific
% absolute paths in the public repository.
inDir = uigetdir(pwd, 'Select STEP01B_Resting_QC_Final input folder');
if isequal(inDir, 0)
    error('STEP01B input folder was not selected.');
end

rootDir = fileparts(inDir);
